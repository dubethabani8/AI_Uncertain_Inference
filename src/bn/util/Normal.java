...
public class Normal implements Inferencer {
	...
	public Distribution query(RandomVariable X, Assignment e, BayesianNetwork network) {
		...
		return normal(X, e, network, 100000);
	}
	
	public Distribution normal(RandomVariable X, Assignment e, BayesianNetwork network, double numSamples) {
